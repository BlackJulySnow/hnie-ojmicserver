...
class Client(Iface):
    ...
    def add_player(self, sid, tid):
        ...
        """
        self.send_add_player(sid, tid)
        return self.recv_add_player()

    def send_add_player(self, sid, tid):
...
class Processor(Iface, TProcessor):
    ...
    def process_add_player(self, seqid, iprot, oprot):
        ...
        result = add_player_result()
        try:
            result.success = self._handler.add_player(args.sid, args.tid)
...
class add_player_args(object):
    ...
    def write(self, oprot):
        ...
        if self.tid is not None:
            oprot.writeFieldBegin('tid', TType.I32, 2)
